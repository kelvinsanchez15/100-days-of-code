...
**Thoughts:** I have a feeling that I'm going blind working with Glitch, if we add some bugs to it, let's just say that it's not much fun.
...
**Today's Progress**: I worked on the layout and the models for the Issue Tracker project.

**Thoughts:** My connection gave me a lot of problems so I spent the rest of the afternoon making a mockup based on Github.
